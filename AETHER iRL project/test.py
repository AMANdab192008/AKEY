"""
AKEY TEST SCRIPT - General and Realtime Chat Selector
========================================================
PURPOSE:
This is a command-line test interface for interacting with A.K.E.Y.
...
WHY IT EXISTS:
- Provides an easy way to test the AKEY API without building a frontend
...
def print_header():
    print("\n" + "="*60)
    print("🤖 A.K.E.Y - General & Realtime Chat")
    print("="*60)
    print("\nModes:")
...
def send_message(message, mode):
    """
    Send a message to the appropriate AKEY endpoint.
    ...
    Returns:
        str: AKEY's response, or an error message if something went wrong
