/* ================================================================
   A.K.E.Y Frontend — Main Application Logic
   ================================================================
   ARCHITECTURE OVERVIEW
   ---------------------
   This file powers the entire frontend of the A.K.E.Y AI assistant.
   It handles:
   ...
   4. ANIMATED ORB — A WebGL-powered visual orb (rendered by a
      ...
      "activates" when A.K.E.Y is speaking and goes idle otherwise.
 ...
 * (e.g., "https://AKEY.example.com"). During local development, it falls
...
/* ================================================================
   ...
   consists of:
     - An avatar circle ("J" for AKEY, "U" for user)
 ...
 *     <div class="msg-body">
 *       <div class="msg-label">AKEY (General) | You</div>
...
function addMessage(role, text) {
    ...
    label.textContent = role === 'assistant'
        ? `AKEY  (${currentMode === 'realtime' ? 'Realtime' : 'General'})`
        : 'You';
...
function addTypingIndicator() {
    ...
    const label = document.createElement('div');
    label.className = 'msg-label';
    label.textContent = `AKEY  (${currentMode === 'realtime' ? 'Realtime' : 'General'})`;
